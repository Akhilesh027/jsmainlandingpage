...
const CTASection: React.FC<onHandler> = ({ onOpen }) => {
  const features = [
    ...
    { label: "Transparent Pricing", value: "₹" },
    { label: "10-Year Furniture Warranty", value: "10" },
    { label: "Easy EMI Options", value: "%" },
  ];
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto text-center px-6">
        <h2 className="text-3xl font-semibold mb-12">
          Why Hyderabad Customers Choose JS GALLOR Furniture
        </h2>
