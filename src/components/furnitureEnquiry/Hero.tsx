...
import video from '../../images/furniture Banner Landscape.mp4' 
export default function Hero({ onOpen }: onHandler) {
  return (
    <section className="relative h-screen flex items-center pt-20 overflow-hidden">
      ...
      {/* Content */}
      <div className="relative max-w-xl px-6 text-white z-10">
        ...
        <p className="mb-6 text-lg text-white/90">
          Premium furniture solutions designed for comfort, style, and
          Vastu harmony — from concept to installation.
        </p>
